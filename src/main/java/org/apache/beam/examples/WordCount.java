...
public class WordCount {
  ...
  public static class FormatAsTextFn extends SimpleFunction<KV<String, Long>, String> {
    ...
    public String apply(KV<String, Long> input) {
      System.out.println("FormatAsTextFn:" + input.getKey() + ": " + input.getValue());
  ...
  static void runWordCount(WordCountOptions options) {
    ...
    fields.add(new TableFieldSchema().setName("count").setType("STRING"));
              ...
              @ProcessElement
                public void processElement(ProcessContext c) {
                  TableRow row = new TableRow()
                          ...
                          .set("count", c.element().getValue().toString());
                  c.output(row);
                }
            }))
        //.apply("WriteCounts", TextIO.write().to(options.getOutput()));
            .apply("WriteCounts", BigQueryIO.writeTableRows().to(options.getOutput())//
                    .withSchema(schema)//
